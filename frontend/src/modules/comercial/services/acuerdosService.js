...
const acuerdosService = {
  ...
  getSituacionVia1: (acuerdoId) => apiClient.get(`/api/acuerdos/${acuerdoId}/situacion-via1`).then((res) => res.data),
  getSituacionVia1Facturas: (acuerdoId, obligacionId) => apiClient.get(`/api/acuerdos/${acuerdoId}/situacion-via1/obligaciones/${obligacionId}/facturas`).then((res) => res.data),
  getSituacionVia1Cobranzas: (acuerdoId, obligacionId) => apiClient.get(`/api/acuerdos/${acuerdoId}/situacion-via1/obligaciones/${obligacionId}/cobranzas`).then((res) => res.data),
