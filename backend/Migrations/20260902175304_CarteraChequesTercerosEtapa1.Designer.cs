...
namespace BudgetControl.Api.Migrations
{
    ...
    [Migration("20260902175304_CarteraChequesTercerosEtapa1")]
    partial class CarteraChequesTercerosEtapa1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BudgetControl.Api.Models.Collections.ChequeTercero", b =>
                {
                    ...
                    b.Property<string>("UsuarioAcreditacion")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("usuario_acreditacion");
                    ...
                    b.Property<string>("UsuarioDeposito")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("usuario_deposito");
            ...
            modelBuilder.Entity("BudgetControl.Api.Models.Collections.ChequeTercero", b =>
                {
                    ...
                    b.HasOne("BudgetControl.Api.Models.Collections.CobranzaMedioPago", "CobranzaMedioPago")
                        .WithOne("ChequeTercero")
                        .HasForeignKey("BudgetControl.Api.Models.Collections.ChequeTercero", "CobranzaMedioPagoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
